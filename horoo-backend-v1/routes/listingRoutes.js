...
const {createListing , editListing , deleteListing, updateAvailability, getMyListings} = require("../controllers/listingController");
...
router.get("/my-listings", auth, isOwner, getMyListings);
